...
void FileFillerFinalround(){	
   ...
   // X-ray cascade
   std::string filexNaI = path+"round_both_sides_NaI_1e5goldcascade.root";
   std::string filexSci = path+"round_both_sides_Sci_1e5goldcascade.root";

   // Mu-decay
   std::string filemuNaI = path+"round_both_sides_NaI_1e5mudecay.root";
   std::string filemuSci = path+"round_both_sides_Sci_1e5mudecay.root";
