   ...
   for (int phi=0; phi<length; phi++) {
      for (int z=0; z < length; z++) {
	     ...
	     zshift = zArray[z];
		   ...
		   std::string filemuSciD1 = "../../simdata/recover/6xSciDs_4mm_Al_4mm_Al_300mm_BGO_40mm_Al_Cav_"+TString(phishiftss.str())+"mm_phi_"+TString(zshiftss.str())+"mm_z_shifted_1e5mudecay_SciD1.txt";
		   std::string filexSciD1 = "../../simdata/recover/6xSciDs_4mm_Al_4mm_Al_300mm_BGO_40mm_Al_Cav_"+TString(phishiftss.str())+"mm_phi_"+TString(zshiftss.str())+"mm_z_shifted_1e5goldcascade_SciD1.txt";
		   std::string filemuSciD2 = "../../simdata/recover/6xSciDs_4mm_Al_4mm_Al_300mm_BGO_40mm_Al_Cav_"+TString(phishiftss.str())+"mm_phi_"+TString(zshiftss.str())+"mm_z_shifted_1e5mudecay_SciD2.txt";
		   std::string filexSciD2 = "../../simdata/recover/6xSciDs_4mm_Al_4mm_Al_300mm_BGO_40mm_Al_Cav_"+TString(phishiftss.str())+"mm_phi_"+TString(zshiftss.str())+"mm_z_shifted_1e5goldcascade_SciD2.txt";
		   std::string filemuSciDT = "../../simdata/recover/6xSciDs_4mm_Al_4mm_Al_300mm_BGO_40mm_Al_Cav_"+TString(phishiftss.str())+"mm_phi_"+TString(zshiftss.str())+"mm_z_shifted_1e5mudecay_SciDT.txt";
		   std::string filexSciDT = "../../simdata/recover/6xSciDs_4mm_Al_4mm_Al_300mm_BGO_40mm_Al_Cav_"+TString(phishiftss.str())+"mm_phi_"+TString(zshiftss.str())+"mm_z_shifted_1e5goldcascade_SciDT.txt";
		   std::string filemuSciDB = "../../simdata/recover/6xSciDs_4mm_Al_4mm_Al_300mm_BGO_40mm_Al_Cav_"+TString(phishiftss.str())+"mm_phi_"+TString(zshiftss.str())+"mm_z_shifted_1e5mudecay_SciDB.txt";
		   std::string filexSciDB = "../../simdata/recover/6xSciDs_4mm_Al_4mm_Al_300mm_BGO_40mm_Al_Cav_"+TString(phishiftss.str())+"mm_phi_"+TString(zshiftss.str())+"mm_z_shifted_1e5goldcascade_SciDB.txt";
		   std::string filemuSciDL = "../../simdata/recover/6xSciDs_4mm_Al_4mm_Al_300mm_BGO_40mm_Al_Cav_"+TString(phishiftss.str())+"mm_phi_"+TString(zshiftss.str())+"mm_z_shifted_1e5mudecay_SciDL.txt";
		   std::string filexSciDL = "../../simdata/recover/6xSciDs_4mm_Al_4mm_Al_300mm_BGO_40mm_Al_Cav_"+TString(phishiftss.str())+"mm_phi_"+TString(zshiftss.str())+"mm_z_shifted_1e5goldcascade_SciDL.txt";
		   std::string filemuSciDR = "../../simdata/recover/6xSciDs_4mm_Al_4mm_Al_300mm_BGO_40mm_Al_Cav_"+TString(phishiftss.str())+"mm_phi_"+TString(zshiftss.str())+"mm_z_shifted_1e5mudecay_SciDR.txt";
		   std::string filexSciDR = "../../simdata/recover/6xSciDs_4mm_Al_4mm_Al_300mm_BGO_40mm_Al_Cav_"+TString(phishiftss.str())+"mm_phi_"+TString(zshiftss.str())+"mm_z_shifted_1e5goldcascade_SciDR.txt";
		   std::string filemuBGOD1 = "../../simdata/recover/6xSciDs_4mm_Al_4mm_Al_300mm_BGO_40mm_Al_Cav_"+TString(phishiftss.str())+"mm_phi_"+TString(zshiftss.str())+"mm_z_shifted_1e5mudecay_BGOD1.txt";
		   std::string filexBGOD1 = "../../simdata/recover/6xSciDs_4mm_Al_4mm_Al_300mm_BGO_40mm_Al_Cav_"+TString(phishiftss.str())+"mm_phi_"+TString(zshiftss.str())+"mm_z_shifted_1e5goldcascade_BGOD1.txt";
		   ...
		   c->cd(1);
		   gPad->SetLogy();
		   hmuSciD1->SetTitle("4-mm Al, 4-mm Al, 2 x 4-mm SciD_{1,2}, 4 x 10-mm SciD_{T,B,L,R}, 300-mm BGO, 40-mm Al Cavity, "+TString(phishiftss.str())+"-mm #Phi-shift, "+TString(zshiftss.str())+"-mm z-shift: #mu-decay vs X-ray cascade SciD_{1}");
		   ...
		   c->cd(2);
		   gPad->SetLogy();
		   hmuSciD2->SetTitle("4-mm Al, 4-mm Al, 2 x 4-mm SciD_{1,2}, 4 x 10-mm SciD_{T,B,L,R}, 300-mm BGO, 40-mm Al Cavity, "+TString(phishiftss.str())+"-mm #Phi-shift, "+TString(zshiftss.str())+"-mm z-shift: #mu-decay vs X-ray cascade SciD_{2}");
		   ...
		   c->cd(3);
		   gPad->SetLogy();
		   hmuSciDT->SetTitle("4-mm Al, 4-mm Al, 2 x 4-mm SciD_{1,2}, 4 x 10-mm SciD_{T,B,L,R}, 300-mm BGO, 40-mm Al Cavity, "+TString(phishiftss.str())+"-mm #Phi-shift, "+TString(zshiftss.str())+"-mm z-shift: #mu-decay vs X-ray cascade SciD_{T}");
		   ...
		   c->cd(4);
		   gPad->SetLogy();
		   hmuSciDB->SetTitle("4-mm Al, 4-mm Al, 2 x 4-mm SciD_{1,2}, 4 x 10-mm SciD_{T,B,L,R}, 300-mm BGO, 40-mm Al Cavity, "+TString(phishiftss.str())+"-mm #Phi-shift, "+TString(zshiftss.str())+"-mm z-shift: #mu-decay vs X-ray cascade SciD_{B}");
		   ...
		   c->cd(5);
		   gPad->SetLogy();
		   hmuSciDL->SetTitle("4-mm Al, 4-mm Al, 2 x 4-mm SciD_{1,2}, 4 x 10-mm SciD_{T,B,L,R}, 300-mm BGO, 40-mm Al Cavity, "+TString(phishiftss.str())+"-mm #Phi-shift, "+TString(zshiftss.str())+"-mm z-shift: #mu-decay vs X-ray cascade SciD_{L}");
		   ...
		   c->cd(6);
		   gPad->SetLogy();
		   hmuSciDR->SetTitle("4-mm Al, 4-mm Al, 2 x 4-mm SciD_{1,2}, 4 x 10-mm SciD_{T,B,L,R}, 300-mm BGO, 40-mm Al Cavity, "+TString(phishiftss.str())+"-mm #Phi-shift, "+TString(zshiftss.str())+"-mm z-shift: #mu-decay vs X-ray cascade SciD_{R}");
		   ...
		   c->cd(7);
		   gPad->SetLogy();
		   hmuBGOD1->SetTitle("4-mm Al, 4-mm Al, 2 x 4-mm SciD_{1,2}, 4 x 10-mm SciD_{T,B,L,R}, 300-mm BGO, 40-mm Al Cavity, "+TString(phishiftss.str())+"-mm #Phi-shift, "+TString(zshiftss.str())+"-mm z-shift: #mu-decay vs X-ray cascade BGOD_{1}");
		   ...
		   c->cd(8);
		   gPad->SetLogy();
		   hmuSciD1Z->SetTitle("4-mm Al, 4-mm Al, 2 x 4-mm SciD_{1,2}, 4 x 10-mm SciD_{T,B,L,R}, 300-mm BGO, 40-mm Al Cavity, "+TString(phishiftss.str())+"-mm #Phi-shift, "+TString(zshiftss.str())+"-mm z-shift: #mu-decay vs X-ray cascade SciD_{1}");
		   ...
		   c->cd(9);
		   gPad->SetLogy();
		   hmuSciD2Z->SetTitle("4-mm Al, 4-mm Al, 2 x 4-mm SciD_{1,2}, 4 x 10-mm SciD_{T,B,L,R}, 300-mm BGO, 40-mm Al Cavity, "+TString(phishiftss.str())+"-mm #Phi-shift, "+TString(zshiftss.str())+"-mm z-shift: #mu-decay vs X-ray cascade SciD_{2}");
		   ...
		   c->cd(10);
		   gPad->SetLogy();
		   hmuSciDTZ->SetTitle("4-mm Al, 4-mm Al, 2 x 4-mm SciD_{1,2}, 4 x 10-mm SciD_{T,B,L,R}, 300-mm BGO, 40-mm Al Cavity, "+TString(phishiftss.str())+"-mm #Phi-shift, "+TString(zshiftss.str())+"-mm z-shift: #mu-decay vs X-ray cascade SciD_{T}");
		   ...
		   c->cd(11);
		   gPad->SetLogy();
		   hmuSciDBZ->SetTitle("4-mm Al, 4-mm Al, 2 x 4-mm SciD_{1,2}, 4 x 10-mm SciD_{T,B,L,R}, 300-mm BGO, 40-mm Al Cavity, "+TString(phishiftss.str())+"-mm #Phi-shift, "+TString(zshiftss.str())+"-mm z-shift: #mu-decay vs X-ray cascade SciD_{B}");
		   ...
		   c->cd(12);
		   gPad->SetLogy();
		   hmuSciDLZ->SetTitle("4-mm Al, 4-mm Al, 2 x 4-mm SciD_{1,2}, 4 x 10-mm SciD_{T,B,L,R}, 300-mm BGO, 40-mm Al Cavity, "+TString(phishiftss.str())+"-mm #Phi-shift, "+TString(zshiftss.str())+"-mm z-shift: #mu-decay vs X-ray cascade SciD_{L}");
		   ...
		   c->cd(13);
		   gPad->SetLogy();
		   hmuSciDRZ->SetTitle("4-mm Al, 4-mm Al, 2 x 4-mm SciD_{1,2}, 4 x 10-mm SciD_{T,B,L,R}, 300-mm BGO, 40-mm Al Cavity, "+TString(phishiftss.str())+"-mm #Phi-shift, "+TString(zshiftss.str())+"-mm z-shift: #mu-decay vs X-ray cascade SciD_{R}");
		   ...
		   c->cd(14);
		   gPad->SetLogy();
		   hmuBGOD1Z->SetTitle("4-mm Al, 4-mm Al, 2 x 4-mm SciD_{1,2}, 4 x 10-mm SciD_{T,B,L,R}, 300-mm BGO, 40-mm Al Cavity, "+TString(phishiftss.str())+"-mm #Phi-shift, "+TString(zshiftss.str())+"-mm z-shift: #mu-decay vs X-ray cascade BGOD_{1}");
		   ...
		   grmuSD1->SetTitle("4-mm Al, 4-mm Al, 2 x 4-mm SciD_{1,2}, 4 x 10-mm SciD_{T,B,L,R}, 300-mm BGO, 40-mm Al Cavity, "+TString(phishiftss.str())+"-mm #Phi-shift, "+TString(zshiftss.str())+"-mm z-shift: #mu-decay vs X-ray cascade SciD_{1}");
		   ...
		   grmuSD2->SetTitle("4-mm Al, 4-mm Al, 2 x 4-mm SciD_{1,2}, 4 x 10-mm SciD_{T,B,L,R}, 300-mm BGO, 40-mm Al Cavity, "+TString(phishiftss.str())+"-mm #Phi-shift, "+TString(zshiftss.str())+"-mm z-shift: #mu-decay vs X-ray cascade SciD_{2}");
		   ...
		   grmuSDT->SetTitle("4-mm Al, 4-mm Al, 2 x 4-mm SciD_{1,2}, 4 x 10-mm SciD_{T,B,L,R}, 300-mm BGO, 40-mm Al Cavity, "+TString(phishiftss.str())+"-mm #Phi-shift, "+TString(zshiftss.str())+"-mm z-shift: #mu-decay vs X-ray cascade SciD_{T}");
		   ...
		   grmuSDB->SetTitle("4-mm Al, 4-mm Al, 2 x 4-mm SciD_{1,2}, 4 x 10-mm SciD_{T,B,L,R}, 300-mm BGO, 40-mm Al Cavity, "+TString(phishiftss.str())+"-mm #Phi-shift, "+TString(zshiftss.str())+"-mm z-shift: #mu-decay vs X-ray cascade SciD_{B}");
		   ...
		   grmuSDL->SetTitle("4-mm Al, 4-mm Al, 2 x 4-mm SciD_{1,2}, 4 x 10-mm SciD_{T,B,L,R}, 300-mm BGO, 40-mm Al Cavity, "+TString(phishiftss.str())+"-mm #Phi-shift, "+TString(zshiftss.str())+"-mm z-shift: #mu-decay vs X-ray cascade SciD_{L}");
		   ...
		   grmuSDR->SetTitle("4-mm Al, 4-mm Al, 2 x 4-mm SciD_{1,2}, 4 x 10-mm SciD_{T,B,L,R}, 300-mm BGO, 40-mm Al Cavity, "+TString(phishiftss.str())+"-mm #Phi-shift, "+TString(zshiftss.str())+"-mm z-shift: #mu-decay vs X-ray cascade SciD_{R}");
		   ...
		   grmuBD1->SetTitle("4-mm Al, 4-mm Al, 2 x 4-mm SciD_{1,2}, 4 x 10-mm SciD_{T,B,L,R}, 300-mm BGO, 40-mm Al Cavity, "+TString(phishiftss.str())+"-mm #Phi-shift, "+TString(zshiftss.str())+"-mm z-shift: #mu-decay vs X-ray cascade BGOD_{1}");
		   ...
		   c->SaveAs("Recover_Planar_6xSDs_BGO_4mm_Al_4mm_Al_300mm_BGO_40mm_Al_Cav_"+TString(phishiftss.str())+"mm_phi_shift_"+TString(zshiftss.str())+"mm_z_shift_MULTI_Edep.pdf");
		   c->SaveAs("Recover_Planar_6xSDs_BGO_4mm_Al_4mm_Al_300mm_BGO_40mm_Al_Cav_"+TString(phishiftss.str())+"mm_phi_shift_"+TString(zshiftss.str())+"mm_z_shift_MULTI_Edep.png");
		   c->SaveAs("Recover_Planar_6xSDs_BGO_4mm_Al_4mm_Al_300mm_BGO_40mm_Al_Cav_"+TString(phishiftss.str())+"mm_phi_shift_"+TString(zshiftss.str())+"mm_z_shift_MULTI_Edep.C");

           std::cout << std::endl;
           std::cout << "Phi = " << phishift << ", z = " << zshift << std::endl;
           std::cout << std::endl;
           std::cout << std::endl;
