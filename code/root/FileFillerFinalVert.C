...
void FileFillerFinalVert(){	
   ...
   // X-ray cascade
   std::string filex = path+material+"_cav_Sci_"+phishift+"mm_phi_"+zshift+"mm_z_dB_"+dB+"mm_dA1_"+dA1+"mm_1e5goldcascade.root";
   
   // Mu-decay
   std::string filemu = path+material+"_cav_Sci_"+phishift+"mm_phi_"+zshift+"mm_z_dB_"+dB+"mm_dA1_"+dA1+"mm_1e5mudecay.root";
