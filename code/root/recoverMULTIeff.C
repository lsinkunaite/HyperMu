...
void recoverMULTIeff(){
   ...
   float PeXarrZ0fixed[length][nsamps] = {,}; // z=0
   float PeearrZ0fixed[length][nsamps] = {,};
   float PXXarrZ0fixed[length][nsamps] = {,};
   float PXearrZ0fixed[length][nsamps] = {,};
   float PeXXXarrZ0fixedr[length][nsamps] = {,};
   float PeXarrZ15fixed[length][nsamps] = {,}; // z=15
   float PeearrZ15fixed[length][nsamps] = {,};
   float PXXarrZ15fixed[length][nsamps] = {,};
   float PXearrZ15fixed[length][nsamps] = {,};
   float PeXXXarrZ15fixedr[length][nsamps] = {,};
   float PeXarrZ30fixed[length][nsamps] = {,}; // z=30
   float PeearrZ30fixed[length][nsamps] = {,};
   float PXXarrZ30fixed[length][nsamps] = {,};
   float PXearrZ30fixed[length][nsamps] = {,};
   float PeXXXarrZ30fixedr[length][nsamps] = {,};
   float PeXarrZ45fixed[length][nsamps] = {,}; // z=45
   float PeearrZ45fixed[length][nsamps] = {,};
   float PXXarrZ45fixed[length][nsamps] = {,};
   float PXearrZ45fixed[length][nsamps] = {,};
   float PeXXXarrZ45fixedr[length][nsamps] = {,};
   float PeXarrZ60fixed[length][nsamps] = {,}; // z=60
   float PeearrZ60fixed[length][nsamps] = {,};
   float PXXarrZ60fixed[length][nsamps] = {,};
   float PXearrZ60fixed[length][nsamps] = {,};
   float PeXXXarrZ60fixedr[length][nsamps] = {,};
   ...
   for (int phi=0; phi<length; phi++) {
      ...
      for (int z=0; z<length; z++) {
		 ...
		 for (int i=0; i<nsamps; i++) {
			...
			PeXarrPhifixed[z][i] = PeXvectorN2[0][i];
			PXXarrPhifixed[z][i] = PXXvectorN2[0][i];
			PeXXXarrPhifixedr[z][i] = (PeXvectorN2[0][i])/(double)(PXXvectorN2[0][i]);
		 ...
		 grPXXN2->SetTitle("N2 normalisation {absolute} OR: 4-mm Al, 4-mm Al, 4-mm SciD_{1,2}, 4 x 10-mm SciD_{T,B,L,R}, 300-mm BGO, 40-mm Al Cavity Ring, 50-mm #Phi-shift, 15-mm z-shift [10^5 events]");
		 ...
		 c->SaveAs("Recover_Planar_4mm_Al_4mm_Al_6xSDs_300mm_BGO_40mm_Al_Cav_"+TString(phishiftss.str())+"mm_phi_"+TString(zshiftss.str())+"mm_z_shift_MULTIplicities_eff.pdf");
		 c->SaveAs("Recover_Planar_4mm_Al_4mm_Al_6xSDs_300mm_BGO_40mm_Al_Cav_"+TString(phishiftss.str())+"mm_phi_"+TString(zshiftss.str())+"mm_z_shift_MULTIplicities_eff.png");
		 c->SaveAs("Recover_Planar_4mm_Al_4mm_Al_6xSDs_300mm_BGO_40mm_Al_Cav_"+TString(phishiftss.str())+"mm_phi_"+TString(zshiftss.str())+"mm_z_shift_MULTIplicities_eff.C");
	  ...
	  gPad->SetLogy();
	  gPad->SetGrid(1,1);
	  TGraph *grPXXz0 = new TGraph(nsamps,Ethrmu,PXXarrPhifixed[0]);
	  grPXXz0->SetTitle("P_{X->X}: 4-mm Al, 4-mm Al, 4-mm SciD_{1,2}, 4 x 10-mm SciD_{T,B,L,R}, 300-mm BGO, 40-mm Al Cavity Ring, "+TString(phishiftss.str())+"-mm #Phi-shift, {0, 15, 30, 45, 60}-mm z-shift [10^5 events]");
	  grPXXz0->GetXaxis()->SetTitle("E_{THR} [MeV]");
	  grPXXz0->GetXaxis()->SetRangeUser(0,2.05);
	  //grPXXz0->GetYaxis()->SetRangeUser(1e-4,1.1);
	  grPXXz0->GetYaxis()->SetTitle("P_{X->X}(E_{THR})");
	  grPXXz0->GetYaxis()->SetTitleOffset(1.8);
	  grPXXz0->GetYaxis()->SetMoreLogLabels(1);
	  grPXXz0->SetLineColor(kRed);
	  grPXXz0->SetLineWidth(3);
	  grPXXz0->Draw("ALP");
	  TGraph *grPXXz15 = new TGraph(nsamps,Ethrmu,PXXarrPhifixed[1]); 
	  grPXXz15->SetLineColor(kBlack);
	  grPXXz15->SetLineWidth(3);
	  grPXXz15->Draw("LP");
	  TGraph *grPXXz30 = new TGraph(nsamps,Ethrmu,PXXarrPhifixed[2]);
	  grPXXz30->SetLineColor(kBlue);
	  grPXXz30->SetLineWidth(3);
	  grPXXz30->Draw("LP");
	  TGraph *grPXXz45 = new TGraph(nsamps,Ethrmu,PXXarrPhifixed[3]);
	  grPXXz45->SetLineColor(kGreen-2);
	  grPXXz45->SetLineWidth(3);
	  grPXXz45->Draw("LP");
	  TGraph *grPXXz60 = new TGraph(nsamps,Ethrmu,PXXarrPhifixed[4]);
	  grPXXz60->SetLineColor(kMagenta);
	  grPXXz60->SetLineWidth(3);
	  grPXXz60->Draw("LP");
	  legPXXPhifixed = new TLegend(0.2,-0.005,0.4,0.08);
	  legPXXPhifixed->AddEntry(grPXXz0,"z = 0 mm","lp");
	  legPXXPhifixed->AddEntry(grPXXz15,"z = 15 mm","lp");
	  legPXXPhifixed->AddEntry(grPXXz30,"z = 30 mm","lp");
	  legPXXPhifixed->AddEntry(grPXXz45,"z = 45 mm","lp");
	  legPXXPhifixed->AddEntry(grPXXz60,"z = 60 mm","lp");
	  legPXXPhifixed->Draw();
	  
	  d->cd(2);
	  gPad->SetLogy();
	  gPad->SetGrid(1,1);
	  TGraph *grPeXz0 = new TGraph(nsamps,Ethrmu,PeXarrPhifixed[0]);
	  grPeXz0->SetTitle("P_{e->X}: 4-mm Al, 4-mm Al, 4-mm SciD_{1,2}, 4 x 10-mm SciD_{T,B,L,R}, 300-mm BGO, 40-mm Al Cavity Ring, "+TString(phishiftss.str())+"-mm #Phi-shift, {0, 15, 30, 45, 60}-mm z-shift [10^5 events]");
	  grPeXz0->GetXaxis()->SetTitle("E_{THR} [MeV]");
	  grPeXz0->GetXaxis()->SetRangeUser(0,2.05);
	  //grPeXz0->GetYaxis()->SetRangeUser(1e-4,1.1);
	  grPeXz0->GetYaxis()->SetTitle("P_{e->X}(E_{THR})");
	  grPeXz0->GetYaxis()->SetTitleOffset(1.8);
	  grPeXz0->GetYaxis()->SetMoreLogLabels(1);
	  grPeXz0->SetLineColor(kRed);
	  grPeXz0->SetLineWidth(3);
	  grPeXz0->Draw("ALP");
	  TGraph *grPeXz15 = new TGraph(nsamps,Ethrmu,PeXarrPhifixed[1]); 
	  grPeXz15->SetLineColor(kBlack);
	  grPeXz15->SetLineWidth(3);
	  grPeXz15->Draw("LP");
	  TGraph *grPeXz30 = new TGraph(nsamps,Ethrmu,PeXarrPhifixed[2]);
	  grPeXz30->SetLineColor(kBlue);
	  grPeXz30->SetLineWidth(3);
	  grPeXz30->Draw("LP");
	  TGraph *grPeXz45 = new TGraph(nsamps,Ethrmu,PeXarrPhifixed[3]);
	  grPeXz45->SetLineColor(kGreen-2);
	  grPeXz45->SetLineWidth(3);
	  grPeXz45->Draw("LP");
	  TGraph *grPeXz60 = new TGraph(nsamps,Ethrmu,PeXarrPhifixed[4]);
	  grPeXz60->SetLineColor(kMagenta);
	  grPeXz60->SetLineWidth(3);
	  grPeXz60->Draw("LP");
	  legPeXPhifixed = new TLegend(0.2,-0.005,0.4,0.08);
	  legPeXPhifixed->AddEntry(grPeXz0,"z = 0 mm","lp");
	  legPeXPhifixed->AddEntry(grPeXz15,"z = 15 mm","lp");
	  legPeXPhifixed->AddEntry(grPeXz30,"z = 30 mm","lp");
	  legPeXPhifixed->AddEntry(grPeXz45,"z = 45 mm","lp");
	  legPeXPhifixed->AddEntry(grPeXz60,"z = 60 mm","lp");
	  legPeXPhifixed->Draw();

	  
	  d->SaveAs("Recover_Planar_4mm_Al_4mm_Al_6xSDs_300mm_BGO_40mm_Al_Cav_"+TString(phishiftss.str())+"mm_phi_ALL_z_shift_MULTIplicities_eff.pdf");
	  d->SaveAs("Recover_Planar_4mm_Al_4mm_Al_6xSDs_300mm_BGO_40mm_Al_Cav_"+TString(phishiftss.str())+"mm_phi_ALL_z_shift_MULTIplicities_eff.png");
	  d->SaveAs("Recover_Planar_4mm_Al_4mm_Al_6xSDs_300mm_BGO_40mm_Al_Cav_"+TString(phishiftss.str())+"mm_phi_ALL_z_shift_MULTIplicities_eff.C");
