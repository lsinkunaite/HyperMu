...
void finalcavNVCuGlasseff(){
   ...
   // Names of the files
   // X-ray cascade
   std::string filexSciD1 = "../../simdata/final/Cu_cav_Sci_noveto_"+phishift+"mm_phi_"+zshift+"mm_z_no_Al_1e5goldcascade_SciD1.txt";
   std::string filexSciD2 = "../../simdata/final/Cu_cav_Sci_noveto_"+phishift+"mm_phi_"+zshift+"mm_z_no_Al_1e5goldcascade_SciD2.txt";
   std::string filexSciD3 = "../../simdata/final/Cu_cav_Sci_noveto_"+phishift+"mm_phi_"+zshift+"mm_z_no_Al_1e5goldcascade_SciD3.txt";
   std::string filexSciDS1 = "../../simdata/final/Cu_cav_Sci_noveto_"+phishift+"mm_phi_"+zshift+"mm_z_no_Al_1e5goldcascade_SciDS1.txt";
   std::string filexSciDS2 = "../../simdata/final/Cu_cav_Sci_noveto_"+phishift+"mm_phi_"+zshift+"mm_z_no_Al_1e5goldcascade_SciDS2.txt";
   std::string filexBGOD1 = "../../simdata/final/Cu_cav_Sci_noveto_"+phishift+"mm_phi_"+zshift+"mm_z_no_Al_1e5goldcascade_BGOD1.txt";
   std::string filexBGOD2 = "../../simdata/final/Cu_cav_Sci_noveto_"+phishift+"mm_phi_"+zshift+"mm_z_no_Al_1e5goldcascade_BGOD2.txt";
   
   // X-ray cascade
   std::string filex2SciD1 = "../../simdata/final/Glass_cav_Sci_noveto_"+phishift+"mm_phi_"+zshift+"mm_z_no_Al_1e5goldcascade_SciD1.txt";
   std::string filex2SciD2 = "../../simdata/final/Glass_cav_Sci_noveto_"+phishift+"mm_phi_"+zshift+"mm_z_no_Al_1e5goldcascade_SciD2.txt";
   std::string filex2SciD3 = "../../simdata/final/Glass_cav_Sci_noveto_"+phishift+"mm_phi_"+zshift+"mm_z_no_Al_1e5goldcascade_SciD3.txt";
   std::string filex2SciDS1 = "../../simdata/final/Glass_cav_Sci_noveto_"+phishift+"mm_phi_"+zshift+"mm_z_no_Al_1e5goldcascade_SciDS1.txt";
   std::string filex2SciDS2 = "../../simdata/final/Glass_cav_Sci_noveto_"+phishift+"mm_phi_"+zshift+"mm_z_no_Al_1e5goldcascade_SciDS2.txt";
   std::string filex2BGOD1 = "../../simdata/final/Glass_cav_Sci_noveto_"+phishift+"mm_phi_"+zshift+"mm_z_no_Al_1e5goldcascade_BGOD1.txt";
   std::string filex2BGOD2 = "../../simdata/final/Glass_cav_Sci_noveto_"+phishift+"mm_phi_"+zshift+"mm_z_no_Al_1e5goldcascade_BGOD2.txt";


   // Mu-decay
   std::string filemuSciD1 = "../../simdata/final/Cu_cav_Sci_noveto_"+phishift+"mm_phi_"+zshift+"mm_z_no_Al_1e5mudecay_SciD1.txt";
   std::string filemuSciD2 = "../../simdata/final/Cu_cav_Sci_noveto_"+phishift+"mm_phi_"+zshift+"mm_z_no_Al_1e5mudecay_SciD2.txt";
   std::string filemuSciD3 = "../../simdata/final/Cu_cav_Sci_noveto_"+phishift+"mm_phi_"+zshift+"mm_z_no_Al_1e5mudecay_SciD3.txt";
   std::string filemuSciDS1 = "../../simdata/final/Cu_cav_Sci_noveto_"+phishift+"mm_phi_"+zshift+"mm_z_no_Al_1e5mudecay_SciDS1.txt";
   std::string filemuSciDS2 = "../../simdata/final/Cu_cav_Sci_noveto_"+phishift+"mm_phi_"+zshift+"mm_z_no_Al_1e5mudecay_SciDS2.txt";
   std::string filemuBGOD1 = "../../simdata/final/Cu_cav_Sci_noveto_"+phishift+"mm_phi_"+zshift+"mm_z_no_Al_1e5mudecay_BGOD1.txt";
   std::string filemuBGOD2 = "../../simdata/final/Cu_cav_Sci_noveto_"+phishift+"mm_phi_"+zshift+"mm_z_no_Al_1e5mudecay_BGOD2.txt";

   std::string filemu2SciD1 = "../../simdata/final/Glass_cav_Sci_noveto_"+phishift+"mm_phi_"+zshift+"mm_z_no_Al_1e5mudecay_SciD1.txt";
   std::string filemu2SciD2 = "../../simdata/final/Glass_cav_Sci_noveto_"+phishift+"mm_phi_"+zshift+"mm_z_no_Al_1e5mudecay_SciD2.txt";
   std::string filemu2SciD3 = "../../simdata/final/Glass_cav_Sci_noveto_"+phishift+"mm_phi_"+zshift+"mm_z_no_Al_1e5mudecay_SciD3.txt";
   std::string filemu2SciDS1 = "../../simdata/final/Glass_cav_Sci_noveto_"+phishift+"mm_phi_"+zshift+"mm_z_no_Al_1e5mudecay_SciDS1.txt";
   std::string filemu2SciDS2 = "../../simdata/final/Glass_cav_Sci_noveto_"+phishift+"mm_phi_"+zshift+"mm_z_no_Al_1e5mudecay_SciDS2.txt";
   std::string filemu2BGOD1 = "../../simdata/final/Glass_cav_Sci_noveto_"+phishift+"mm_phi_"+zshift+"mm_z_no_Al_1e5mudecay_BGOD1.txt";
   std::string filemu2BGOD2 = "../../simdata/final/Glass_cav_Sci_noveto_"+phishift+"mm_phi_"+zshift+"mm_z_no_Al_1e5mudecay_BGOD2.txt";
   ...
   std::vector< std::vector<double> > PXevector(Xfiles.size()/14,std::vector<double>(nsamps));
   std::vector< std::vector<double> > PXXvector(Xfiles.size()/14,std::vector<double>(nsamps));          
   std::vector< std::vector<double> > PXevector(Xfiles.size()/14,std::vector<double>(nsamps));
   std::vector< std::vector<double> > PXXvector(Xfiles.size()/14,std::vector<double>(nsamps));      
   // Normalisation 2 [abs = total] :: X-ray cascade [glass]
   std::vector< std::vector<double> > PXevector2(Xfiles.size()/14,std::vector<double>(nsamps));
   std::vector< std::vector<double> > PXXvector2(Xfiles.size()/14,std::vector<double>(nsamps));          
   std::vector< std::vector<double> > PXevector2(Xfiles.size()/14,std::vector<double>(nsamps));
   std::vector< std::vector<double> > PXXvector2(Xfiles.size()/14,std::vector<double>(nsamps));      

   // Normalisation 2 [abs = total] :: Mu-decay [Cu]
   std::vector< std::vector<double> > Peevector(mufiles.size()/14,std::vector<double>(nsamps));
   std::vector< std::vector<double> > PeXvector(mufiles.size()/14,std::vector<double>(nsamps));      
   std::vector< std::vector<double> > Peevector(mufiles.size()/14,std::vector<double>(nsamps));
   std::vector< std::vector<double> > PeXvector(mufiles.size()/14,std::vector<double>(nsamps));      
   // Normalisation 2 [abs = total] :: Mu-decay [glass]
   std::vector< std::vector<double> > Peevector2(mufiles.size()/14,std::vector<double>(nsamps));
   std::vector< std::vector<double> > PeXvector2(mufiles.size()/14,std::vector<double>(nsamps));      
   std::vector< std::vector<double> > Peevector2(mufiles.size()/14,std::vector<double>(nsamps));
   std::vector< std::vector<double> > PeXvector2(mufiles.size()/14,std::vector<double>(nsamps));      
   ...
   for (int k=0; k<((Xfiles.size())/14); k++) {
			  
      // SciD1
	  std::ifstream xfSciD1(TString(Xfiles[k*14]));
	  ...
	  // SciD2
	  std::ifstream xfSciD2(TString(Xfiles[(k*14)+1]));
	  ...
	  // SciD3
	  std::ifstream xfSciD3(TString(Xfiles[(k*14)+2]));
	  ...
	  // SciDS1
	  std::ifstream xfSciDS1(TString(Xfiles[(k*14)+3]));
	  ...
	  // SciDS2
	  std::ifstream xfSciDS2(TString(Xfiles[(k*14)+4]));
	  ...
	  // BGOD1
	  std::ifstream xfBGOD1(TString(Xfiles[(k*14)+5]));
	  ...
	  // BGOD2
	  std::ifstream xfBGOD2(TString(Xfiles[(k*14)+6]));
      ...
      // SciD1
	  std::ifstream x2fSciD1(TString(Xfiles[(k*14)+7]));
	  ...
	  // SciD2
	  std::ifstream x2fSciD2(TString(Xfiles[(k*14)+8]));
	  ...
	  // SciD3
	  std::ifstream x2fSciD3(TString(Xfiles[(k*14)+9]));
	  ...
	  // SciDS1
	  std::ifstream x2fSciDS1(TString(Xfiles[(k*14)+10]));
	  ...
	  // SciDS2
	  std::ifstream x2fSciDS2(TString(Xfiles[(k*14)+11]));
	  ...
	  // BGOD1
	  std::ifstream x2fBGOD1(TString(Xfiles[(k*14)+12]));
	  ...
	  // BGOD2
	  std::ifstream x2fBGOD2(TString(Xfiles[(k*14)+13]));
   ...
   for (int k=0; k<((mufiles.size())/14); k++) {
   
      // SciD1mu
	  std::ifstream mufSciD1(TString(mufiles[k*14]));
	  ...
	  // SciD2mu
	  std::ifstream mufSciD2(TString(mufiles[(k*14)+1]));
	  ...
	  // SciD3mu
	  std::ifstream mufSciD3(TString(mufiles[(k*14)+2]));
	  ...
	  // SciDS1mu
	  std::ifstream mufSciDS1(TString(mufiles[(k*14)+3]));
	  ...
	  // SciDS2mu
	  std::ifstream mufSciDS2(TString(mufiles[(k*14)+4]));
	  ...
	  // BGOD1mu
	  std::ifstream mufBGOD1(TString(mufiles[(k*14)+5]));
	  ...
	  // BGOD2mu
	  std::ifstream mufBGOD2(TString(mufiles[(k*14)+6]));
      ...
      // SciD1mu2
	  std::ifstream mu2fSciD1(TString(mufiles[(k*14)+7]));
	  ...
	  // SciD2mu
	  std::ifstream mu2fSciD2(TString(mufiles[(k*14)+8]));
	  ...
	  // SciD3mu
	  std::ifstream mu2fSciD3(TString(mufiles[(k*14)+9]));
	  ...
	  // SciDS1mu
	  std::ifstream mu2fSciDS1(TString(mufiles[(k*14)+10]));
	  ...
	  // SciDS2mu
	  std::ifstream mu2fSciDS2(TString(mufiles[(k*14)+11]));
	  ...
	  // BGOD1mu
	  std::ifstream mu2fBGOD1(TString(mufiles[(k*14)+12]));
	  ...
	  // BGOD2mu
	  std::ifstream mu2fBGOD2(TString(mufiles[(k*14)+13]));
		 ...
		 for (int a=0; a<allvEvIDBD1x[0].size(); a++) {
		    ...
		    if ((allvEdepSD1x[i][a] < Ethr1) && (allvEdepSD2x[i][a] < Ethr1) && (allvEdepSD3x[i][a] < Ethr1)) {
			   if ((allvEdepBD1x[i][a] > Ethr) || (allvEdepBD1x[i][a] < Ethr22) && (allvEdepBD2x[i][a] > Ethr) && (allvEdepBD2x[i][a] < Ethr22)) {
			      if ((allvEdepSDS1x[i][a] < Ethr3) && (allvEdepSDS2x[i][a] < Ethr3)) {
				     XXray += 1;
				  } else { Xelec += 1; }
			   } else { Xelec += 1; }
		    } else { Xelec += 1; }
		 ...
		 for (int a=0; a<allvEvIDBD1x2[0].size(); a++) {
		    ...
		    if ((allvEdepSD1x2[i][a] < Ethr1) && (allvEdepSD2x2[i][a] < Ethr1) && (allvEdepSD3x2[i][a] < Ethr1)) {
			   if ((allvEdepBD1x2[i][a] > Ethr) || (allvEdepBD1x2[i][a] < Ethr22) && (allvEdepBD2x2[i][a] > Ethr) && (allvEdepBD2x2[i][a] < Ethr22)) {
			      if ((allvEdepSDS1x2[i][a] < Ethr3) && (allvEdepSDS2x2[i][a] < Ethr3)) {
				     XXray2 += 1;
				  } else { Xelec2 += 1; }
			   } else { Xelec2 += 1; }
		    } else { Xelec2 += 1; }
		 ...
		 for (int a=0; a<allvEvIDBD1mu[0].size(); a++) {
		    ...
		    if ((allvEdepSD1mu[i][a] < Ethr1) && (allvEdepSD2mu[i][a] < Ethr1) && (allvEdepSD3mu[i][a] < Ethr1)) {
		       if ((allvEdepBD1mu[i][a] > Ethr) || (allvEdepBD1mu[i][a] < Ethr22) && (allvEdepBD2mu[i][a] > Ethr) && (allvEdepBD2mu[i][a] < Ethr22)) {
			      if ((allvEdepSDS1mu[i][a] < Ethr3) && (allvEdepSDS2mu[i][a] < Ethr3)) {
				     eXray += 1;
				  } else { eelec += 1; }
			   } else { eelec += 1; }
		    } else { eelec += 1; }
		 ...
		 for (int a=0; a<allvEvIDBD1mu2[0].size(); a++) {
		    ...
		    if ((allvEdepSD1mu2[i][a] < Ethr1) && (allvEdepSD2mu2[i][a] < Ethr1) && (allvEdepSD3mu2[i][a] < Ethr1)) {
		       if ((allvEdepBD1mu2[i][a] > Ethr) || (allvEdepBD1mu2[i][a] < Ethr22) && (allvEdepBD2mu2[i][a] > Ethr) && (allvEdepBD2mu2[i][a] < Ethr22)) {
			      if ((allvEdepSDS1mu2[i][a] < Ethr3) && (allvEdepSDS2mu2[i][a] < Ethr3)) {
				     eXray2 += 1;
				  } else { eelec2 += 1; }
			   } else { eelec2 += 1; }
		    } else { eelec2 += 1; }
   ...
   f->SaveAs("Cu_glass_Sci_noveto_eff.pdf");
   f->SaveAs("Cu_glass_Sci_noveto_eff.png");
   f->SaveAs("Cu_glass_Sci_noveto_eff.C");
